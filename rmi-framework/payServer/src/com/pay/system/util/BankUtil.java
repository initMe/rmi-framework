...
public class BankUtil {
	...
	public static String getNameOfBank(String carCode) {
		int code = Integer.parseInt(carCode.substring(0, 6));
		for (int i : bankBin) {
			if (i == code) {
				return bankName[i];
			}
	...
	public static void main(String[] args) {
		System.out.println(BankUtil.getNameOfBank("6212261202026728361"));
	}
}

...
public class AlipayNotify {
	 ...
	 * @return 生成的签名结果
	 */
	public static boolean getSignVeryfy(Map<String, String> Params, String sign, String key, String signType) {
		Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
		LoggerUtil.info(AlipayNotify.class, "代签名参数：" + JsonUtil.objToJson(sParaNew) + "，签名：" + sign + "，安全码：" + key + "，签名类型：" + signType);
		//获取待签名字符串

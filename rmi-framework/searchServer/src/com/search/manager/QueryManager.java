...
public class QueryManager {
	...
	/**
	 * 查询管理的对象创建
	 * @param dbName	lucene库名称{Searcher.WOYAO_DB || Searcher.RESUME_DB 等}
	 */
	 ...
	 */
	public void addParserQuery(String key, String val, boolean parserIsAnd, boolean isAnd) throws ParseException {
